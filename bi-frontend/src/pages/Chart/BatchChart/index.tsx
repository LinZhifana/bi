...
const MainCard: React.FC = () => {
  ...
  const showAlert = () => {
    ...
    if (alert === alertState.info) {
      return <Alert severity="info">请稍后在 my chart 中查看</Alert>
    }
  }
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await API.instance.post('/chart/generate/mq', formData, {
        headers: {
